...
namespace PlayerBots.AI.SkillHelpers
{
    ...
    class DroneTechHelper : AiSkillHelper
    {
        ...
        {
            AISkillDriver skill2_heal = gameObject.AddComponent<AISkillDriver>() as AISkillDriver;
            skill2_heal.customName = "Secondary";
            skill2_heal.skillSlot = RoR2.SkillSlot.Secondary;
            skill2_heal.requireSkillReady = true;
            skill2_heal.moveTargetType = AISkillDriver.TargetType.NearestFriendlyInSkillRange;
            skill2_heal.selectionRequiresTargetLoS = false;
            skill2_heal.activationRequiresTargetLoS = false;
            skill2_heal.activationRequiresAimConfirmation = false;
            skill2_heal.maxUserHealthFraction = 0.7f;
            skill2_heal.movementType = AISkillDriver.MovementType.StrafeMovetarget;
            skill2_heal.aimType = AISkillDriver.AimType.AtMoveTarget;
            skill2_heal.ignoreNodeGraph = true;
            skill2_heal.resetCurrentEnemyOnNextDriverSelection = false;
            skill2_heal.noRepeat = true;
            skill2_heal.shouldSprint = false;
