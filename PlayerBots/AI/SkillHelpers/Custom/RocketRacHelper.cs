...
{
    [SkillHelperSurvivor("RocketRacBody")]
    [CustomSurvivor("https://thunderstore.io/package/VCR/RocketRaccoon/", "1.0.4")]
    class RocketRacHelper : AiSkillHelper
    {
        public override void InjectSkills(GameObject gameObject, BaseAI ai)
        {
            ...
            skill2.resetCurrentEnemyOnNextDriverSelection = true;
