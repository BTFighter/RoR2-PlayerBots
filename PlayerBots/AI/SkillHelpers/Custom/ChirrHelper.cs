...
namespace PlayerBots.AI.SkillHelpers.Custom
{
    ...
    class ChirrHelper : AiSkillHelper
    {
        public override void InjectSkills(GameObject gameObject, BaseAI ai)
        {
            ...
            skill2.moveTargetType = AISkillDriver.TargetType.NearestFriendlyInSkillRange;
            ...
            skill4.maxTargetHealthFraction = 1.20f;
            ...
            skill1_shoot.resetCurrentEnemyOnNextDriverSelection = true;
