...
namespace PlayerBots.AI.SkillHelpers.Custom
{
    ...
    class ExecutionerHelper : AiSkillHelper
    {
        public override void InjectSkills(GameObject gameObject, BaseAI ai)
        {
            ...
            /* Continuously switches between Primary and Secondary, will think of any way to make this work*/
